    ...
    <Card className="w-full max-w-[360px] shadow-lg overflow-hidden">
      ...
      <div className="relative h-24 bg-muted">
        ...
        {onMore && (
          <button
            onClick={onMore}
            className="absolute top-3 right-3 w-7 h-7 rounded-full bg-background/70 backdrop-blur-sm flex items-center justify-center text-foreground hover:bg-background transition-colors"
          >
